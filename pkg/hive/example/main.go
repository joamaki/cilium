...
// CellFlags registers the fields in ExampleConfig as command-line arguments.
// The receiver is the "defaultExampleConfig" we pass to cell.Config.
func (def ExampleConfig) CellFlags(flags *pflag.FlagSet) {
