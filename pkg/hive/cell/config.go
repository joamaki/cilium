...
// ConfigCell is a cell for configuration.
...
func (s *ConfigCell) RegisterFlags(parent *pflag.FlagSet) {
	flags := pflag.NewFlagSet("", pflag.ContinueOnError)
	s.defaultConfig.CellFlags(flags)
...
func (s *ConfigCell) unmarshalConfig(settings map[string]any) (any, error) {
...
func decoderConfig(target *CellConfig) *mapstructure.DecoderConfig {
...
func (s *ConfigCell) ToOption(settings map[string]any) (fx.Option, error) {
...
func Config[Cfg CellConfig](def Cfg) Cell {
	return &ConfigCell{defaultConfig: def}
}
