...
// FIXME: Create proper constructor with start/stop hooks to open the maps.
// This implementation along with reconciler should probably live in the lbmap
// packxage?
