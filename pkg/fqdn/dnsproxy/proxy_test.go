...
func setupDNSProxyTestSuite(tb testing.TB) *DNSProxyTestSuite {
	...
	testSelectorCache.UpdateIdentities(identity.IdentityMap{
		dstID1: labels.ToLabelArray(labels.NewLabels(labels.NewLabel("Dst1", "test", labels.LabelSourceK8s))),
		dstID2: labels.ToLabelArray(labels.NewLabels(labels.NewLabel("Dst2", "test", labels.LabelSourceK8s))),
		dstID3: labels.ToLabelArray(labels.NewLabels(labels.NewLabel("Dst3", "test", labels.LabelSourceK8s))),
		dstID4: labels.ToLabelArray(labels.NewLabels(labels.NewLabel("Dst4", "test", labels.LabelSourceK8s))),
	}, nil, wg)
	wg.Wait()
